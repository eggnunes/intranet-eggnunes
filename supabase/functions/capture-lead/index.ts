  ...
  try {
    ...
    const { data: lead, error: insertError } = await supabase
      ...
      .insert({
        ...
        utm_placement: cleanUnresolvedPlaceholder(utm_placement),
        utm_device: cleanUnresolvedPlaceholder(utm_device),
        utm_publisher: cleanUnresolvedPlaceholder(utm_publisher),
