...
function getSafeErrorMessage(error: Error | unknown): string {
  ...
  if (errorMessage.includes('telefone inválido') || errorMessage.includes('formato') || errorMessage.includes('telefone cadastrado')) {
    return 'Número de telefone inválido ou não cadastrado. Verifique os dados do cliente.';
  }
